...
def check_links_from_file(file_path, output_file):
    ...
    Also writes live URLs to the Shellive.txt file.
    """
    ...
    with open(output_file, mode='w', newline='') as csvfile:
        ...
        # Open the Shellive.txt file to save live URLs
        with open("Shellive.txt", "w") as shellive_file:
            ...
            for url in urls:
                ...
                if url:
                    ...
                    if status == "live":
                        ...
                        shellive_file.write(url + "\n")  # Save live URLs to Shellive.txt
                    else:
...
def test_single_link():
    ...
    if url:
        ...
        if status == "live":
            print(Colorate.Vertical(Colors.green_to_blue, f"{url} - {status} (Code: {code}, Response Time: {response_time})"))
            # Save live link to Shellive.txt
            with open("Shellive.txt", "a") as file:
                file.write(url + "\n")
        else:
            print(Colorate.Vertical(Colors.red_to_yellow, f"{url} - {status} (Code: {code}, Response Time: {response_time})"))
    else:
